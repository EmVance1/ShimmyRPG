...
sf::Vector2i into_vector2i(const rj::Value& arr) {
    return sf::Vector2i(arr.GetArray()[0].GetInt(), arr.GetArray()[1].GetInt());
}

sf::Vector2u into_vector2u(const rj::Value& arr) {
    return sf::Vector2u(arr.GetArray()[0].GetUint(), arr.GetArray()[1].GetUint());
}


sf::FloatRect into_floatrect(const rj::Value& arr) {
    return sf::FloatRect(
...
sf::IntRect into_intrect(const rj::Value& arr) {
    return sf::IntRect(
...
sf::Color into_color(const rj::Value& arr) {
